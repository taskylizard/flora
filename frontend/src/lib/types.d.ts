...
export interface paths {
  ...
  "/deployments/deployments/{guild_id}": {
    parameters: {
      query?: never;
      header?: never;
      path?: never;
...
export interface components {
  schemas: {
    ...
    DeploymentRequest: {
      ...
      code: string;
      /** @description Optional scripting language hint. Defaults to `typescript`. */
    ...
    /**
     * @description Supported scripting languages for deployments.
     * @enum {string}
     */
